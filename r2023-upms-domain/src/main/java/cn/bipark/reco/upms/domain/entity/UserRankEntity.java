...
@Component
public class UserRankEntity extends BaseAggregate<BiUserRank> {
    /**
     * 通知个人排行榜被创建
     */
    public void notifyCreated() {
        publish(new UserRankCreatedEvent(getData()));
    }
    ...
    public void notifyUpdated() {
        publish(new UserRankUpdatedEvent(getData()));
    }
    ...
    public void notifyDeleted() {
        publish(new UserRankDeletedEvent(getData()));
    }
