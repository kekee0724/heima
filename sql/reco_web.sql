/*
 ...
 Source Schema         : reco_web

 Target Server Type    : MySQL
 Target Server Version : 80029 (8.0.29)
 File Encoding         : 65001

 Date: 06/03/2023 21:32:35
*/
...
-- ----------------------------
-- Table structure for DomainEventEntry
-- ----------------------------
DROP TABLE IF EXISTS `DomainEventEntry`;
CREATE TABLE `DomainEventEntry` (
  `id` bigint NOT NULL AUTO_INCREMENT,
  `globalIndex` bigint DEFAULT NULL,
...
-- ----------------------------
-- Table structure for TokenEntry
-- ----------------------------
DROP TABLE IF EXISTS `TokenEntry`;
CREATE TABLE `TokenEntry` (
  `id` bigint NOT NULL AUTO_INCREMENT,
  `segment` int DEFAULT NULL,
  `processorName` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci DEFAULT NULL,
...
-- ----------------------------
-- Records of TokenEntry
-- ----------------------------
BEGIN;
INSERT INTO `TokenEntry` (`id`, `segment`, `processorName`, `token`, `tokenType`, `timestamp`, `owner`) VALUES (1, 0, 'cn.bipark.reco.order.web.handler', NULL, NULL, '2023-03-06T13:32:34.833Z', '69904@TFMacBook-Pro.local');
COMMIT;
