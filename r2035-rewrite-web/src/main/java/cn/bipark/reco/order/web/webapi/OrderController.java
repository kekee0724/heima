...
//    @PostAuthorize("appLog('REWRITE', '删除未知对象', '编号%d', #id)")
...
//    @PreAuthorize("hasAuthority('ORDER_DEL')")
//    @PostAuthorize("appLog('REWRITE', '批量删除未知对象', '编号%s', #ids)")
...
//    @PostAuthorize("appLog('REWRITE', '添加未知对象', '%s，编号%d', #vm.toString(), returnObject)")
...
//    @PostAuthorize("appLog('REWRITE', '修改未知对象', '%s，编号%d', #vm.toString(), #id)")
